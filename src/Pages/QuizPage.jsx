...
//       return <ResourceView />;
//     } else if (currentView === 'score_history') {
//       return <ScoreHistoryView />;
//     } else {
//       return <LandingPage />; // Default view
//     }
//   };
...
const QuizPage = () => {
  ...
  const LandingPage = () => {
    const features = [
      ...
      {
        title: "Progress Tracking",
        description: "Visualize your journey and see your progress over time.",
        view: "progress",
      },
      {
        title: "Resource Library",
        description: "Access curated articles, tools, and support for dyslexia.",
        view: "resources",
      },
    ];
          ...
          <div className="features">
            {features.map((feature, i) => (
              <Card key={i} className="feature-card" onClick={() => setCurrentView(feature.view)}>
                ...
                <CardContent>
                  <DyslexiaFriendlyText>{feature.description}</DyslexiaFriendlyText>
                </CardContent>
              </Card>
            ))}
          </div>
  ...
  const renderContent = () => {
    ...
    return <LandingPage />; // simplified for demo
  };

  return <div className="quiz-app">{renderContent()}</div>;
};
